quiz = [
    ...
    },
    {
        ...
        "options": {"a": "O2", "b": "H2O", "c": "CO2", "d": "N2O"},
        "answer": "b",
    },
    {
    ...
    {
        "question": "8. Which element is represented by the symbol 'Au'?",
        "options": {"a": "Silver", "b": "Iron", "c": "Gold", "d": "Aluminum"},
        "answer": "c",
    },
    {
        "question": "9. Who is the author of *Harry Potter*?",
        "options": {
            "a": "J.R.R. Tolkien",
            "b": "J.K. Rowling",
            "c": "Stephen King",
